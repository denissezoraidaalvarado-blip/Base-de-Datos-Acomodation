...
-- Consulta 1 Agregar un nuevo propietario--
INSERT INTO owners (
    first_name,
    last_name,
    company_name,
...
VALUES (
    'Carlos',
    'Martínez',
    'Turismo El Salvador S.A.',
    'carlos.martinez@turismo.com',
    '503-7777-8888',
    '0614-250180-101-5',
    'Colonia Escalón, Calle Principal #123',
    'Local 2',
    'San Salvador',
    'San Salvador',
    'El Salvador',
...
-- Consulta 2 Crear alojamiento vinculado --
...
VALUES ('El Salvador','San Salvador', 'San Salvador','Escalón','75 Avenida Norte #123',
    '1101',13.7030,-89.2200);

-- Conuslta 3 Registrar huésped y reserva --
INSERT INTO guests (
    first_name,
    last_name,
    email,
...
VALUES ('María','González','maria.gonzalez@email.com','7777-1234');
...
--Consulta 6 Filtrar por nacionalidad

SELECT 
    nationality AS pais,
    COUNT(*) AS total_huespedes
FROM guests
WHERE LOWER(nationality) LIKE LOWER('%mex%')
GROUP BY nationality
ORDER BY total_huespedes DESC

--Consulta 7 Reservas por fechas	Uso--
...
SET base_price_per_night = base_price_per_night * 1.15
WHERE is_active = true;



---Consulta 9 Actualizar estado --

UPDATE bookings b
SET booking_status_id = s.booking_status_id
FROM booking_statuses s
...
-- Consulta 11 combinar información de dos tablas relacionadas
...
SELECT 
    ...
    t.type_name AS tipo,
    CONCAT(o.first_name, ' ', o.last_name) AS propietario,
    l.country,
    l.city,
    a.max_guests,
...
INNER JOIN accommodation_types t 
...
--Consulta 13 unir información de dos o más tablas relacionadas.
...
--Consulta 16 Total ingresos	SUM

SELECT 
    SUM(amount) AS total_ingresos
FROM payments;

--Consulta 17 Promedio rating	AVG
SELECT
    accommodation_id,
...
--Consulta 18 Top alojamientos	COUNT + LIMIT
SELECT
    a.accommodation_id,
...
--Consulta 19 Más de 3 reservas	GROUP BY + HAVING
SELECT 
    guest_id,
...
--Consulta 20 Alojamiento más caro - SubConsulta
